...
class StatePolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any State');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any State');
    }
    ...
    {
        return $user->checkPermissionTo('replicate State');
    }
    ...
    {
        return $user->checkPermissionTo('reorder State');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any State');
    }
}
